...
<main>
    <h3>Modificar comic</h3>
    <p>Llena el siguiente formulario para modificar tu comic</p>
    <section class="section">
    <form action="libroweb" method="post" id="formModificar">
        <label for="">Id comic</label>
        <input type="number" name="idlib" id="idlib" class="controls" placeholder="Id del libro" required>
        ...
        <input class="buttons" type="submit" name="action" value="Actualizar">
    </form>
    </section>
